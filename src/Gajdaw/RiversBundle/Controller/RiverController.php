...
namespace Gajdaw\RiversBundle\Controller;
...
use Gajdaw\RiversBundle\Entity\River;
use Gajdaw\RiversBundle\Form\RiverType;
...
class RiverController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('GajdawRiversBundle:River')->findAll();
     ...
     * @Method("POST")
     * @Template("GajdawRiversBundle:River:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('GajdawRiversBundle:River')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("GajdawRiversBundle:River:edit.html.twig")
     */
