...
use Gajdaw\BDDTutorial\GeographyBundle\Form\CountryType;
...
class CountryController extends Controller
{
     ...
     * @Method("POST")
     * @Template("GajdawBDDTutorialGeographyBundle:Country:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('GajdawBDDTutorialGeographyBundle:Country')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("GajdawBDDTutorialGeographyBundle:Country:edit.html.twig")
     */
