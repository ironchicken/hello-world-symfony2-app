...
use Gajdaw\BDDTutorial\GeographyBundle\Form\ChannelType;
...
class ChannelController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('GajdawBDDTutorialGeographyBundle:Channel')->findAll();
     ...
     *
     * @Route("/", name="channel_create")
     * @Method("POST")
     * @Template("GajdawBDDTutorialGeographyBundle:Channel:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('GajdawBDDTutorialGeographyBundle:Channel')->find($id);
    ...
    */
     ...
     *
     * @Route("/{id}", name="channel_update")
     * @Method("PUT")
     * @Template("GajdawBDDTutorialGeographyBundle:Channel:edit.html.twig")
     */
